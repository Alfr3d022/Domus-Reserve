...
const salas = [
    ...
    { nomeDentro: 'Sala 2 - Bloco Laranjão', imagem: 'imagens/sala2.avif', rota: 'sala1.html' },
    { nomeDentro: 'Sala 3 - Bloco Laranjão', imagem: 'imagens/sala3.jpeg', rota: 'sala1.html' },
    { nomeDentro: 'Sala 4 - Bloco Laranjão', imagem: 'imagens/sala4.png', rota: 'sala1.html' }
];

// Informações sobre Eventos
const InstalaçõesUnifeb = [
    { nomeDentro: 'Quadra', imagem: 'imagens/quadra.jpg' },
    { nomeDentro: 'Anfiteatro', imagem: 'imagens/teatro.webp' },
...
const laboratorios = [
    { nomeDentro: 'T.I - Laboratórios 1', imagem: 'imagens/laboratorioTI1.jpg' },
    { nomeDentro: 'T.I - Laboratórios 2', imagem: 'imagens/laboratorioTI2.jpg' },
    { nomeDentro: 'T.I - Laboratórios 3', imagem: 'imagens/laboratorioTI3.jpg' },
    { nomeDentro: 'M.V - Laboratórios 1', imagem: 'imagens/laboratorioMV1.jpg' }
];
